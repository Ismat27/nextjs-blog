const projects_data = [
  ...
  {
    id: "2",
    image: "/images/smart_farm_tool.png",
  ...
  {
    id: "3",
    image: "/images/smart_mart.png",
    title: "Smart Mart",
    intro:
      "Modern day ecommerce web application for shopping different kinds of goods and commodities",
    tools: ["React", "Styled-Components", "Node", "Express", "Mongoose"],
    link: "https://smart-mart.netlify.app/",
  },
  {
    id: "4",
    ...
    intro:
      "This is an app for obtaining information on  countries demograhic data",
    tools: ["NextJs"],
    link: "https://countries-info-psi.vercel.app/",
  },
  {
    id: "5",
    image: "/images/quizzical_home.png",
    title: "Quzzical",
    intro:
      "A quiz app, intended to serve user as a means of passing time while also catching fun.",
    tools: ["React"],
    link: "https://smart-quizzical.netlify.app/",
  },
  {
    id: "6",
